                ...
                <div class="container">
                    <div class="wptb-service--inner">
                        <div class="row">
                            ...
                            @foreach ($service->subServiceCategories as $subservice )
                                <div class="col-lg-4 col-sm-6">
                                    <div class="wptb-image-box1 wow fadeInLeft">
                                        <div class="wptb-item--inner">
                                            <div class="wptb-item--holder">
                                                <h3 class="wptb-item--title"><a href="service-details.html">{{$subservice->sub_service_name}}</a></h3>
                                                <p class="wptb-item--description">{{$subservice->banner_short_title}}</p>
                                                ...
                                                <div class="wptb-item--image">
                                                    @if( $subservice->multipleImages->where('type', 'logo')->first())
                                                        <img src="{{ asset('storage/' . $subservice->multipleImages->where('type', 'logo')->first()->image) }}" width="120" class="mb-2">
                                                    @endif
                                                    {{-- <a href="#" class="wptb-item-link"><img src="assets/img/services/1.jpg" alt="img"></a> --}}
                                                </div>
                                                
                                                <div class="wptb-item--button">
                                                    <a class="btn-three black" href="{{route('about.us')}}">
                                                        <span class="btn-wrap">
                                ...
                                <div class="wptb-image-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--holder">
                                            ...
                                            <div class="wptb-item--image">
                                                <a href="#" class="wptb-item-link"><img src="assets/img/services/4.jpg" alt="img"></a>
                                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="wptb-image-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--holder">
                                            <h3 class="wptb-item--title"><a href="service-details.html">Tire Changing & Repair</a></h3>
                                            <p class="wptb-item--description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod </p>
                                            ...
                                            <div class="wptb-item--image">
                                                <a href="#" class="wptb-item-link"><img src="assets/img/services/5.jpg" alt="img"></a>
                                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="wptb-image-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--holder">
                                            <h3 class="wptb-item--title"><a href="service-details.html">Car Interior Designing</a></h3>
                                            <p class="wptb-item--description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod </p>
                                            ...
                                            <div class="wptb-item--image">
                                                <a href="#" class="wptb-item-link"><img src="assets/img/services/6.jpg" alt="img"></a>
                                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="wptb-image-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--holder">
                                            <h3 class="wptb-item--title"><a href="service-details.html">Engine Repair Services</a></h3>
                                            <p class="wptb-item--description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod </p>
                                            ...
                                            <div class="wptb-item--image">
                                                <a href="#" class="wptb-item-link"><img src="assets/img/services/7.jpg" alt="img"></a>
                                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="wptb-image-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--holder">
                                            <h3 class="wptb-item--title"><a href="service-details.html">Car Battery Check</a></h3>
                                            <p class="wptb-item--description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod </p>
                                            ...
                                            <div class="wptb-item--image">
                                                <a href="#" class="wptb-item-link"><img src="assets/img/services/8.jpg" alt="img"></a>
                                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <div class="wptb-image-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner">
                                        <div class="wptb-item--holder">
                                            <h3 class="wptb-item--title"><a href="service-details.html">Tire Blade Changing</a></h3>
                                            <p class="wptb-item--description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod </p>
                                            ...
                                            <div class="wptb-item--image">
                                                <a href="#" class="wptb-item-link"><img src="assets/img/services/9.jpg" alt="img"></a>
                                            </div>
