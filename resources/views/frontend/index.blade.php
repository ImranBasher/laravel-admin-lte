                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="wptb-slider--item">
                                <div class="wptb-slider--image" style="background-image: url('assets/img/slider/1.jpg');"></div>
                                <div class="container">
                                            ...
                                            <div class="col-xxl-7 col-lg-6 col-md-10 col-sm-12">
                                                <div class="wptb-heading">
                                                    <div class="wptb-item--inner">
                                                        <h6 class="wptb-item--subtitle"> BEST AUTOMIBILE DETAILING WORKSHOP </h6>
                                                        <h1 class="wptb-item--title"> One Stop Solution For Car Maintenance Repair & Detailing
                                                            </h1>
                        ...
                        <div class="swiper-slide">
                            <div class="wptb-slider--item">
                                <div class="wptb-slider--image" style="background-image: url('assets/img/slider/2.jpg');"></div>
                                <div class="container">
                                    <div class="wptb-slider--inner">
                                        <div class="row">
                                            <!-- Content Column -->
                                            <div class="col-xxl-7 col-lg-6 col-md-10 col-sm-12">
                                                <div class="wptb-heading">
                                                    <div class="wptb-item--inner">
                                                        <h6 class="wptb-item--subtitle"> BEST AUTOMIBILE DETAILING WORKSHOP </h6>
                                                        <h1 class="wptb-item--title"> Car Maintenance Repair and Detailing with expert hands</h1>
                                                        <div class="wptb-item--button"> 
                                                            <a class="btn-two" href="#">
                                                                <div class="btn-wrap">
                                                                    <span class="text-first"> Contact Us </span> 
                        ...
                        <div class="swiper-slide">
                            <div class="wptb-slider--item">
                                <div class="wptb-slider--image" style="background-image: url('assets/img/slider/3.jpg');"></div>
                                <div class="container">
                                    <div class="wptb-slider--inner">
                                        <div class="row">
                                            <!-- Content Column -->
                                            <div class="col-xxl-7 col-lg-6 col-md-10 col-sm-12">
                                                <div class="wptb-heading">
                                                    <div class="wptb-item--inner">
                                                        <h6 class="wptb-item--subtitle"> BEST AUTOMIBILE DETAILING WORKSHOP </h6>
                                                        <h1 class="wptb-item--title"> Best Place for Car Maintenance and Detailing</h1>
                                                        <div class="wptb-item--button"> 
                                                            <a class="btn-two" href="#">
                                                                <div class="btn-wrap">
                                                                    <span class="text-first"> Contact Us </span> 
                            ...
                            <div class="wptb-image-box1 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        <h3 class="wptb-item--title"><a href="service-details.html">Ceramic Coating</a></h3>
                                        ...
                                        <div class="wptb-item--button">
                                            <a class="btn-three black" href="service-details.html">
                                                <span class="btn-wrap">
                    ...
                    <div class="row pd-top-140">
                        <div class="col-md-6">
                            ...
                            <div class="wptb-image-single wow skewIn">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--image">
                                        <img src="assets/img/more/2.png" alt="img" class="image-main">
                                    </div>
                            ...
                            <div class="wptb-about-company--inner">
                                <div class="wptb-heading">
                                    <div class="wptb-item--inner">
                                        ...
                                        <h1 class="wptb-item--title"> We care for Your Car
                                            just Like You do</h1>

                                        <p class="wptb-item--description">
                                            When you bring your vehicle to Ducatibox Car Mechanic Center, you can rest easy knowing that your vehicle is in professional hands. We take every possible step to ensure that your experience with us is pleasant and efficient.
                                        </p>
                                        <div class="wptb-item--button">
                        ...
                        <div class="wptb-item--inner">
                            <h4 class="wptb-item--text">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="none">
                                    <path d="M25 15.3958L20 0.083252L15 15.3958L0 20.4999L15 25.6041L20 40.9166L25 25.6041L40 20.4999L25 15.3958ZM20 23.9707C18.2 23.9707 16.6 22.5416 16.6 20.4999C16.6 18.6624 18 17.0291 20 17.0291C21.8 17.0291 23.4 18.4583 23.4 20.4999C23.4 22.3374 21.8 23.9707 20 23.9707Z" fill="white" fill-opacity="0.6"/>
                                </svg>
                            </h4>
                            <h4 class="wptb-item--text">
                                <span class="wptb-text-backdrop">Interior</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="none">
                                    <path d="M25 15.3958L20 0.083252L15 15.3958L0 20.4999L15 25.6041L20 40.9166L25 25.6041L40 20.4999L25 15.3958ZM20 23.9707C18.2 23.9707 16.6 22.5416 16.6 20.4999C16.6 18.6624 18 17.0291 20 17.0291C21.8 17.0291 23.4 18.4583 23.4 20.4999C23.4 22.3374 21.8 23.9707 20 23.9707Z" fill="white" fill-opacity="0.6"/>
                                </svg>
                            </h4>
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="col-xxl-7 col-xl-5 p-0">
                            <div class="wptb-video-player1 wow zoomIn" style="background-image: url('assets/img/background/bg-5.jpg');">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--holder">
                                        <div class="wptb-item--button">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="wptb-image-box3 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--image">
                                        <img src="assets/img/services/10.jpg" alt="img">
                                        <div class="wptb-item--button"> 
                                            <a class="btn-three" href="#"> 
                                                <span class="btn-wrap">
                                    ...
                                    <div class="wptb-item--holder">
                                        <div class="wptb-item--wrap-content">
                                            ...
                                            <h2 class="wptb-item--title"><a href="case-details.html">Wheel Replacement</a></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="wptb-image-box3 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--image">
                                        <img src="assets/img/services/11.jpg" alt="img">
                                        <div class="wptb-item--button"> 
                                            <a class="btn-three" href="#"> 
                                                <span class="btn-wrap">
                                                    <span class="text-first"><i class="bi bi-arrow-right"></i></span>
                                    ...
                                    <div class="wptb-item--holder">
                                        <div class="wptb-item--wrap-content">
                                            <p class="wptb-item--description"> Wash</p>
                                            <h2 class="wptb-item--title"><a href="case-details.html">Vehicle Wash</a></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="wptb-image-box3 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    ...
                                    <div class="wptb-item--holder">
                                        <div class="wptb-item--wrap-content">
                                            <p class="wptb-item--description"> Service</p>
                                            <h2 class="wptb-item--title"><a href="case-details.html">Engine Servicing</a></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="wptb-image-box3 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    ...
                                    <div class="wptb-item--holder">
                                        <div class="wptb-item--wrap-content">
                                            <p class="wptb-item--description"> Oiling</p>
                                            <h2 class="wptb-item--title"><a href="case-details.html">Engine Oil Change</a></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
