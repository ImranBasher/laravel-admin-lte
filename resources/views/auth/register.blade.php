                        ...
                        <div class="col-12 col-lg-5">
                            <div class="w-100 h-100 p-4 p-sm-5 p-xl-5 text-white" style="background: linear-gradient(135deg, #111827 0%, #1f2937 100%);">
                                <div class="h-100 d-flex flex-column justify-content-between">
                                    <div>
                                        <h2 class="h3 fw-semibold mb-3">{{ __('Create Account') }}</h2>
                                        <p class="mb-0 opacity-75">Join us to access services, manage bookings, and track updates.</p>
                                    </div>
                                    <div class="mt-4">
                                        <div class="bg-white bg-opacity-10 rounded-4 p-3">
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div>
                                                    <div class="fw-semibold">Fast registration</div>
                                                    <small class="opacity-75">Set up your account in minutes.</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 col-lg-7 bg-white text-dark">
                            <div class="card-body p-4 p-sm-5 p-lg-5">
                                <header class="mb-4 text-center text-lg-start">
                                    <h1 class="h4 fs-4 fs-sm-3 mb-2">{{ __('Register') }}</h1>
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="d-grid d-sm-flex gap-2">
                                        <button type="submit" class="btn auth-btn-outline btn-lg flex-sm-fill">
                                            {{ __('Register') }}
                                        </button>

                                        @if (Route::has('login'))
                                            <a class="btn auth-btn btn-lg flex-sm-fill" href="{{ route('login') }}">
                                                {{ __('Login') }}
                                            </a>
                                        @endif
                                    </div>
