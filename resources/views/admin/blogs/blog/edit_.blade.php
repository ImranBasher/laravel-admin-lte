            ...
            <div class="card card-info">
                ...
                <form method="POST" action="{{ route('admin.blogs.update', $blog->id) }}" enctype="multipart/form-data">
                            ...
                            @foreach ($blog->multipleImages->where('purpose', 'blog_description_1_images') as $image)
                                <div class="mt-2">
                                    ...
                                    <button
                                        ...
                                        style="position:absolute; top:0; right:0; padding:2px 6px; font-size:12px;"
                                    >
                                        ✕
                                    </button>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="meta_description" class="form-control ckeditor">{{ old('meta_description',$blog->meta_description ) }}</textarea>
                    </div> 
